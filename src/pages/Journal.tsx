        ...
        <main className="max-w-6xl mx-auto pt-16 px-6">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-[#64748b] mt-2">
              Welcome back, Mazen. How is your heart today?
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-16">
            ...
            <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-10 relative">
              ...
              <div className="bg-[#f0f4ff]/50 border border-blue-50 rounded-[2rem] p-8 mb-8">
                ...
                <p className="text-xl font-medium text-[#475569] mt-3 italic">
                  "What made you smile today? Write your reflections here..."
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center mt-8 pt-8 border-t border-gray-50 gap-6">
                  ...
                  <div className="flex gap-3">
                    {emojis.map((emoji) => (
                      <button
                        ...
                        className={`text-2xl transition-all hover:scale-125 ${selectedEmoji === emoji.label ? "" : "grayscale opacity-30"}`}
                      >
                        {emoji.char}
                      </button>
                    ))}
                ...
                <button
                  ...
                  className="bg-[#2563eb] text-white px-10 py-4 rounded-2xl font-bold shadow-lg shadow-blue-100 hover:bg-blue-700 transition-all active:scale-95"
                >
                  Save Entry
                </button>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-center px-2">
                ...
                <button
                  ...
                  className="bg-white border-2 border-dashed border-gray-200 text-gray-500 px-6 py-3 rounded-2xl font-bold text-sm hover:border-blue-400 hover:text-blue-500 transition-all flex items-center gap-2"
                >
                  <span>+</span> Add Photo
                </button>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {echoes.map((echo) => (
                  <div key={echo.id} className="group">
                    ...
                    <p className="text-center mt-3 text-sm font-medium text-[#64748b] italic line-clamp-1 px-2">
                      "{echo.title}"
                    </p>
                  </div>
                ))}
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-bottom-5 duration-700">
                ...
                <div className="space-y-6">
                  {history.map((post) => (
                    <div
                      key={post.id}
                      className="bg-white/60 backdrop-blur-sm p-8 rounded-[2rem] border border-white shadow-sm flex flex-col gap-4"
                    >
                      ...
                      <p className="text-lg font-medium text-[#475569] leading-relaxed">
                        {post.content}
                      </p>
                    </div>
                  ))}
          ...
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-6">
            <div className="bg-white rounded-[3rem] p-10 max-w-md w-full shadow-2xl animate-in zoom-in duration-300">
              ...
              <div className="flex gap-4">
                ...
                <button
                  onClick={saveNewEcho}
                  className="flex-[2] bg-[#2563eb] text-white py-4 rounded-2xl font-black shadow-lg"
                >
                  Add Moment
                </button>
              </div>
