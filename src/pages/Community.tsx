  ...
  const [posts, setPosts] = useState<Post[]>([
    {
      ...
      content:
        "بجد فرق معايا جداً في هدوء MINDECHO. اليوم بدأت أول تمرين تأمل من مكتبة الـ Neutral mood. أنصحكم تجربوا تمارين الـ",
      likes: 24,
      image: null,
      ...
      replies: [
        {
          id: 101,
          user: "Sara Hassan",
          text: "فعلاً التمارين دي بتغير المود تماماً!",
          likes: 3,
        },
      ],
    },
    {
      ...
      content:
        "الكتابة فعلاً Journal تخطيت اليوم نوبة قلق كانت صعبة بفضل كتابة مذكراتي.",
      likes: 18,
      image:
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-12 gap-8">
          ...
          <aside className="col-span-3">
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-50 sticky top-0">
              ...
              <div className="space-y-6">
                {["Anxiety Warriors", "Daily Zen", "Student Stress"].map(
                  (group) => (
                    <div
                      key={group}
                      className="flex items-center gap-4 group cursor-pointer hover:bg-gray-50 p-2 rounded-xl transition-all"
                    >
          ...
          <main className="col-span-6 space-y-8">
            ...
            <div className="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-50">
              <div className="flex gap-4">
                <img
                  src="https://api.dicebear.com/8.x/lorelei/svg?seed=Mazen"
              ...
              <div className="flex justify-between items-center mt-6 border-t pt-6">
                <div className="flex gap-3">
                  <button className="p-3 bg-orange-50 rounded-xl hover:bg-orange-100 transition-colors">
                    😊
                  </button>
                ...
                <button
                  ...
                  className="bg-[#2563eb] text-white px-10 py-3.5 rounded-2xl font-black shadow-lg hover:bg-blue-700 transition-all active:scale-95"
                >
                  Share Post
                </button>
              </div>
            ...
            {posts.map((post) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="bg-green-50 text-green-600 px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider">
                    {post.status}
                  </span>
                </div>

                <p
                  className="text-[#64748b] leading-relaxed font-medium mb-6 text-right"
                  dir="rtl"
                >
                  {post.content}
                </p>
                {post.image && (
                  <img
                    src={post.image}
                    className="w-full h-64 object-cover rounded-[2rem] mb-6 shadow-sm"
                    alt="post"
                  />
                )}
                ...
                <div className="flex gap-6 border-t border-gray-50 pt-6">
                  <button
                    ...
                    className="flex items-center gap-2 text-gray-400 hover:text-red-500 font-bold transition-all active:scale-125"
                  >
                    ❤️ <span>{post.likes}</span>
                  </button>
                  <button className="flex items-center gap-2 text-gray-400 hover:text-blue-500 font-bold transition-colors">
                ...
                <div className="mt-8 space-y-4">
                  {post.replies.map((reply) => (
                    <div
                      key={reply.id}
                      className="bg-gray-50 p-5 rounded-[1.5rem] flex justify-between items-start group"
                    >
                      <div>
                        <span className="font-black text-xs text-blue-600 block mb-1">
                          {reply.user}
                        </span>
                  ...
                  <div className="flex gap-3 mt-6">
                    ...
                    <button
                      ...
                      className="bg-blue-600 text-white px-6 py-3 rounded-2xl text-xs font-black hover:bg-blue-700 transition-all active:scale-95 shadow-md"
                    >
                      Reply
                    </button>
                  </div>
          ...
          <aside className="col-span-3 space-y-8">
            <div className="bg-blue-50 p-8 rounded-[2.5rem] border border-blue-100">
              <h4 className="font-black text-[#1e293b] mb-2">
                Live Support Session
              </h4>
              <p className="text-blue-600 text-xs font-bold mb-6">
                Starting in 45 minutes
              </p>
              <button className="w-full bg-white py-3.5 rounded-2xl font-black text-blue-600 shadow-sm hover:shadow-md transition-all">
                Join Webinar
              </button>
            </div>
          </aside>
